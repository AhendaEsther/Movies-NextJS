    ...
    <TopBanner />
      <NavBar/>
          <div className="flex flex-col md:flex-row items-center md:items-start gap-40 py-12  ">
            <div className=" flex ">
              <Image src="/images/next-mobile.avif" alt="Cart and a smartphone" width={900} height={900} className="max-w-full h-auto"/>
            </div>
            <div className="flex-1 flex flex-col justify-center max-w-md w-full py-30">
              ...
              <div className="flex items-center gap-40">
                  <Link href="/home" >
                  <Button variant="default" size="short" onClickHandler={() => {}} className="mb-4"buttonText="Log in"/>
                  </Link>
