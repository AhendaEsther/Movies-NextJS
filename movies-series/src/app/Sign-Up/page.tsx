  ...
  return (
    ...
    {/* <TopBanner /> */}
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-40 py-12  ">
        <div className=" flex ">
          <Image src="/images/create.png" alt="Cart and a smartphone" width={900} height={800} className="max-w-full h-auto"/>
        </div>
            <div className="flex-1 flex flex-col justify-center max-w-md w-full pt-20">
              ...
              <Input value={name} onChange={(e) => setName(e.target.value)} placeholder="Name" className="w-full border-0 border-b-2 border-gray-400 py-2 px-0 rounded-none mb-9" />
              ...
              <Button variant="default" size="full" onClickHandler={() => {}} className="mb-6" buttonText={<a href="/home">Create Account</a>}/>
              <Button variant="google" size="full" className="flex items-center justify-center gap-2 mb-6" onClickHandler={() => {}} buttonText={
                <>
